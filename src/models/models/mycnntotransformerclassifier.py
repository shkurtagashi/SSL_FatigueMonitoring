...
# TODO this model and related configs might assume DEFAULT_FIELDS
...
class MyCNNToTransformerClassifier(SensingModel):
    ...
    def forward(self, inputs_embeds, labels):
        # TODO: check if shorter inputs still result in same embedding size
        #  no, I cannot run shorter inputs through the encoder
